...
public class Ntp1Api {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public okhttp3.Call getTokenMetadataOfIssuanceCall(String tokenid, final ProgressResponseBody.ProgressListener _progressListener, final ProgressRequestBody.ProgressRequestListener _progressRequestListener) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getTokenMetadataOfIssuanceValidateBeforeCall(String tokenid, final ProgressResponseBody.ProgressListener _progressListener, final ProgressRequestBody.ProgressRequestListener _progressRequestListener) throws ApiException {
        ...
        okhttp3.Call localVarCall = getTokenMetadataOfIssuanceCall(tokenid, _progressListener, _progressRequestListener);
        return localVarCall;
    ...
    public GetTokenMetadataResponse getTokenMetadataOfIssuance(String tokenid) throws ApiException {
        ApiResponse<GetTokenMetadataResponse> localVarResp = getTokenMetadataOfIssuanceWithHttpInfo(tokenid);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<GetTokenMetadataResponse> getTokenMetadataOfIssuanceWithHttpInfo(String tokenid) throws ApiException {
        okhttp3.Call localVarCall = getTokenMetadataOfIssuanceValidateBeforeCall(tokenid, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call getTokenMetadataOfIssuanceAsync(String tokenid, final ApiCallback<GetTokenMetadataResponse> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getTokenMetadataOfIssuanceValidateBeforeCall(tokenid, _progressListener, _progressRequestListener);
        Type localVarReturnType = new TypeToken<GetTokenMetadataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
