...
public class GetTokenMetadataResponse {
  ...
  **/
  @ApiModelProperty(value = "Total tokens issued in initial issuance")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tokenId, someUtxo, divisibility, lockStatus, aggregationPolicy, initialIssuanceAmount, totalSupply, numOfHolders, numOfTransfers, numOfIssuance, numOfBurns, firstBlock, issuanceTxid, issueAddress, metadataOfIssuance, metadataOfUtxo);
  }
