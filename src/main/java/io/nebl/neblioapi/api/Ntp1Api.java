...
public class Ntp1Api {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public okhttp3.Call getTokenMetadataCall(String tokenid, BigDecimal verbosity, final ProgressResponseBody.ProgressListener _progressListener, final ProgressRequestBody.ProgressRequestListener _progressRequestListener) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getTokenMetadataValidateBeforeCall(String tokenid, BigDecimal verbosity, final ProgressResponseBody.ProgressListener _progressListener, final ProgressRequestBody.ProgressRequestListener _progressRequestListener) throws ApiException {
        ...
        okhttp3.Call localVarCall = getTokenMetadataCall(tokenid, verbosity, _progressListener, _progressRequestListener);
        return localVarCall;
    ...
    public ApiResponse<GetTokenMetadataResponse> getTokenMetadataWithHttpInfo(String tokenid, BigDecimal verbosity) throws ApiException {
        okhttp3.Call localVarCall = getTokenMetadataValidateBeforeCall(tokenid, verbosity, null, null);
    ...
    public okhttp3.Call getTokenMetadataAsync(String tokenid, BigDecimal verbosity, final ApiCallback<GetTokenMetadataResponse> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getTokenMetadataValidateBeforeCall(tokenid, verbosity, _progressListener, _progressRequestListener);
        Type localVarReturnType = new TypeToken<GetTokenMetadataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public okhttp3.Call getTokenMetadataOfUtxoCall(String tokenid, String utxo, BigDecimal verbosity, final ProgressResponseBody.ProgressListener _progressListener, final ProgressRequestBody.ProgressRequestListener _progressRequestListener) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getTokenMetadataOfUtxoValidateBeforeCall(String tokenid, String utxo, BigDecimal verbosity, final ProgressResponseBody.ProgressListener _progressListener, final ProgressRequestBody.ProgressRequestListener _progressRequestListener) throws ApiException {
        ...
        okhttp3.Call localVarCall = getTokenMetadataOfUtxoCall(tokenid, utxo, verbosity, _progressListener, _progressRequestListener);
        return localVarCall;
    ...
    public ApiResponse<GetTokenMetadataResponse> getTokenMetadataOfUtxoWithHttpInfo(String tokenid, String utxo, BigDecimal verbosity) throws ApiException {
        okhttp3.Call localVarCall = getTokenMetadataOfUtxoValidateBeforeCall(tokenid, utxo, verbosity, null, null);
        Type localVarReturnType = new TypeToken<GetTokenMetadataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public okhttp3.Call getTokenMetadataOfUtxoAsync(String tokenid, String utxo, BigDecimal verbosity, final ApiCallback<GetTokenMetadataResponse> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getTokenMetadataOfUtxoValidateBeforeCall(tokenid, utxo, verbosity, _progressListener, _progressRequestListener);
        Type localVarReturnType = new TypeToken<GetTokenMetadataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
